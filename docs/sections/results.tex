...
\Cref{fig:posenet-losses} shows the SmoothedL1Loss and L1Loss loss curves for a ResNet-152 PoseNet. It is possible to notice that both in each of the two cases, the model is converging without overfitting.
\begin{figure}[htbp]
    \begin{center}
